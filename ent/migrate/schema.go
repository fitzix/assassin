...
var (
	...
	AppsColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Enums: []string{"app", "book"}, Default: app.DefaultType},
		{Name: "icon", Type: field.TypeString},
		{Name: "title", Type: field.TypeString, Nullable: true, Size: 200},
		{Name: "status", Type: field.TypeEnum, Enums: []string{"normal", "abnormal"}, Default: app.DefaultStatus},
	}
	...
	VersionsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"normal", "abnormal"}, Default: version.DefaultStatus},
