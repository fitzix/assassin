...
func (su *SourceUpdate) SetVendorID(id int) *SourceUpdate {
	if su.vendor == nil {
		su.vendor = make(map[int]struct{})
	}
	su.vendor[id] = struct{}{}
	return su
}
...
func (su *SourceUpdate) SetVendor(p *Provider) *SourceUpdate {
	return su.SetVendorID(p.ID)
}
...
// ClearVendor clears the vendor edge to Provider.
func (su *SourceUpdate) ClearVendor() *SourceUpdate {
	su.clearedVendor = true
	return su
}
...
func (su *SourceUpdate) Save(ctx context.Context) (int, error) {
	...
	if len(su.vendor) > 1 {
		return 0, errors.New("ent: multiple assignments on a unique edge \"vendor\"")
	}
	if su.clearedVendor && su.vendor == nil {
		return 0, errors.New("ent: clearing a unique edge \"vendor\"")
	}
	if len(su.version) > 1 {
...
func (su *SourceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := su.vendor; len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   source.VendorTable,
...
// SetVendorID sets the vendor edge to Provider by id.
func (suo *SourceUpdateOne) SetVendorID(id int) *SourceUpdateOne {
	if suo.vendor == nil {
		suo.vendor = make(map[int]struct{})
	}
	suo.vendor[id] = struct{}{}
	return suo
}

// SetVendor sets the vendor edge to Provider.
func (suo *SourceUpdateOne) SetVendor(p *Provider) *SourceUpdateOne {
	return suo.SetVendorID(p.ID)
}
...
// ClearVendor clears the vendor edge to Provider.
func (suo *SourceUpdateOne) ClearVendor() *SourceUpdateOne {
	suo.clearedVendor = true
	return suo
}
...
func (suo *SourceUpdateOne) Save(ctx context.Context) (*Source, error) {
	...
	if suo.clearedVendor && suo.vendor == nil {
		return nil, errors.New("ent: clearing a unique edge \"vendor\"")
	}
...
func (suo *SourceUpdateOne) sqlSave(ctx context.Context) (s *Source, err error) {
	...
	if nodes := suo.vendor; len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   source.VendorTable,
