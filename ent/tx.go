...
func (tx *Tx) Client() *Client {
	return &Client{
		...
		App:      NewAppClient(tx.config),
		Carousel: NewCarouselClient(tx.config),
		Category: NewCategoryClient(tx.config),
		Hot:      NewHotClient(tx.config),
		Provider: NewProviderClient(tx.config),
		Role:     NewRoleClient(tx.config),
		Source:   NewSourceClient(tx.config),
		Tag:      NewTagClient(tx.config),
		User:     NewUserClient(tx.config),
		Version:  NewVersionClient(tx.config),
	}
}
