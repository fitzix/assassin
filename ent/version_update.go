...
func (vu *VersionUpdate) SetStatus(i int8) *VersionUpdate {
	vu.status = &i
	vu.addstatus = nil
	return vu
}
...
func (vu *VersionUpdate) SetNillableStatus(i *int8) *VersionUpdate {
	if i != nil {
		vu.SetStatus(*i)
	}
	return vu
...
func (vu *VersionUpdate) AddStatus(i int8) *VersionUpdate {
	if vu.addstatus == nil {
		vu.addstatus = &i
	} else {
		*vu.addstatus += i
...
func (vu *VersionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value := vu.addstatus; value != nil {
...
// SetStatus sets the status field.
func (vuo *VersionUpdateOne) SetStatus(i int8) *VersionUpdateOne {
	vuo.status = &i
	vuo.addstatus = nil
	return vuo
}
...
// SetNillableStatus sets the status field if the given value is not nil.
func (vuo *VersionUpdateOne) SetNillableStatus(i *int8) *VersionUpdateOne {
	if i != nil {
		vuo.SetStatus(*i)
	}
	return vuo
...
// AddStatus adds i to status.
func (vuo *VersionUpdateOne) AddStatus(i int8) *VersionUpdateOne {
	if vuo.addstatus == nil {
		vuo.addstatus = &i
	} else {
		*vuo.addstatus += i
	}
...
func (vuo *VersionUpdateOne) sqlSave(ctx context.Context) (v *Version, err error) {
	...
	if value := vuo.addstatus; value != nil {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt8,
			Value:  *value,
			Column: version.FieldStatus,
