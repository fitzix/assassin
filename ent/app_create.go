...
func (ac *AppCreate) SetType(i int8) *AppCreate {
	ac._type = &i
	return ac
}

// SetNillableType sets the type field if the given value is not nil.
func (ac *AppCreate) SetNillableType(i *int8) *AppCreate {
	if i != nil {
		ac.SetType(*i)
	}
	return ac
...
func (ac *AppCreate) SetStatus(i int8) *AppCreate {
	ac.status = &i
	return ac
}

// SetNillableStatus sets the status field if the given value is not nil.
func (ac *AppCreate) SetNillableStatus(i *int8) *AppCreate {
	if i != nil {
		ac.SetStatus(*i)
	}
	return ac
