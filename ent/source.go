...
func (e SourceEdges) VendorOrErr() (*Provider, error) {
	if e.loadedTypes[0] {
		if e.Vendor == nil {
...
// QueryVendor queries the vendor edge of the Source.
func (s *Source) QueryVendor() *ProviderQuery {
	return (&SourceClient{s.config}).QueryVendor(s)
}

// QueryVersion queries the version edge of the Source.
func (s *Source) QueryVersion() *VersionQuery {
	return (&SourceClient{s.config}).QueryVersion(s)
}
...
func (s *Source) Update() *SourceUpdateOne {
	return (&SourceClient{s.config}).UpdateOne(s)
}
