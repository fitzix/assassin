...
type User struct {
	...
	RoleID   int    `boil:"role_id" json:"roleID" toml:"roleID" yaml:"roleID"`
	Code     int    `boil:"code" json:"-" toml:"-" yaml:"-"`
	Status   bool   `boil:"status" json:"-" toml:"-" yaml:"-"`
...
var UserWhere = struct {
	...
	Code:     whereHelperint{field: "\"user\".\"code\""},
	Status:   whereHelperbool{field: "\"user\".\"status\""},
}
...
var (
	userAllColumns            = []string{"id", "name", "password", "role_id", "code", "status"}
	userColumnsWithoutDefault = []string{"id", "name", "password", "role_id"}
	userColumnsWithDefault    = []string{"code", "status"}
...
func (q userQuery) One(exec boil.Executor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: failed to execute a one query for user")
	}
...
func (q userQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to count user rows")
	}
...
func (q userQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schema: failed to check if user exists")
	}
...
func (userL) LoadRole(e boil.Executor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`role`), qm.WhereIn(`role.id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func FindUser(exec boil.Executor, iD string, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: unable to select from user")
	}
...
func (o *User) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to insert into user")
	}
...
func (o *User) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schema: unable to update user, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update user row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by update for user")
	}
...
func (q userQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all for user")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected for user")
	}
...
func (o *User) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no user provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("schema: unable to upsert user, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to upsert user")
	}
...
func (o *User) Delete(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete from user")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by delete for user")
	}
...
func (q userQuery) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from user")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by deleteall for user")
	}
...
func UserExists(exec boil.Executor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schema: unable to check if user exists")
	}
